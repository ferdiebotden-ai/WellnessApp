...
exports.onNudgeFeedback = void 0;
 ...
 */
exports.onNudgeFeedback = (0, firestore_1.onDocumentUpdated)('live_nudges/{userId}/entries/{nudgeId}', async (event) => {
    ...
    try {
        ...
        const memory = await (0, memory_1.createFromNudgeFeedback)(userId, nudgeId, protocolId, feedback, `User ${feedback} nudge for ${moduleId} module at ${new Date().toISOString()}`);
        console.log(`[onNudgeFeedback] Created memory ${memory.id} for user ${userId}: ` +
