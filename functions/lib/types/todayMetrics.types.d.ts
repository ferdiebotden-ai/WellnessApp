 ...
 */
export type TodayMetricsPartialUpdate = Partial<Omit<TodayMetricsDocument, 'userId' | 'date'>>;
/**
 * Calculate data completeness based on available fields.
 */
export declare function calculateDataCompleteness(doc: Partial<TodayMetricsDocument>): number;
/**
 * Format baseline comparison string.
 * Returns null if no baseline available.
 */
export declare function formatVsBaseline(current: number | null | undefined, baseline: number | null | undefined, higherIsBetter?: boolean): string | null;
