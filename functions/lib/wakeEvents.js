...
exports.createWakeEvent = createWakeEvent;
exports.getTodayWakeEvent = getTodayWakeEvent;
const http_1 = require("./utils/http");
const firebaseAdmin_1 = require("./firebaseAdmin");
const supabaseClient_1 = require("./supabaseClient");
const wake_1 = require("./services/wake");
// =============================================================================
// VALIDATION
// =============================================================================
 ...
 * }
 */
async function createWakeEvent(req, res) {
    try {
        // 1. Authenticate user
        ...
        const decodedToken = await (0, firebaseAdmin_1.verifyFirebaseToken)(token);
        if (!decodedToken) {
        ...
        const wakeRepo = (0, wake_1.getWakeEventRepository)();
        ...
        const wakeDetector = (0, wake_1.getWakeDetector)();
        ...
        const morningAnchorService = (0, wake_1.getMorningAnchorService)();
 ...
 */
async function getTodayWakeEvent(req, res) {
    try {
        // 1. Authenticate user
        const token = (0, http_1.extractBearerToken)(req);
        if (!token) {
 ...
 */
function buildSourceMetrics(payload, detection) {
