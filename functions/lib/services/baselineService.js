...
exports.getUserBaseline = getUserBaseline;
exports.updateUserBaseline = updateUserBaseline;
exports.initializeBaseline = initializeBaseline;
exports.updateMenstrualTracking = updateMenstrualTracking;
 ...
 */
async function getUserBaseline(supabase, userId) {
    ...
    return (0, recovery_types_1.fromUserBaselineRow)(data);
}
/**
 * Get daily metrics for baseline window (last 14 days).
 */
async function getBaselineWindowMetrics(supabase, userId) {
 ...
 */
function calculateBaselineStats(metrics) {
 ...
 */
async function updateUserBaseline(supabase, userId) {
    ...
    const confidenceLevel = (0, recovery_types_1.determineBaselineConfidence)(stats.hrvSampleCount);
    ...
    const row = (0, recovery_types_1.toUserBaselineRow)(baseline);
 ...
 */
async function initializeBaseline(supabase, userId) {
    const now = new Date();
    ...
    const row = (0, recovery_types_1.toUserBaselineRow)(defaultBaseline);
 ...
 */
async function updateMenstrualTracking(supabase, userId, tracking, cycleDay, lastPeriodStart) {
    const { error } = await supabase
        .from('user_baselines')
        .update({
 ...
 */
async function getBaselineStatus(supabase, userId) {
