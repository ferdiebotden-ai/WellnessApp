...
export async function syncCalendar(req: Request, res: Response): Promise<void> {
  try {
    ...
    const body = req.body as CalendarSyncRequest;
    ...
    if (body.provider === 'device') {
      ...
      const busyBlocks: BusyBlock[] = body.busyBlocks || [];

      result = await calendarService.syncDeviceCalendar(
        userId,
        busyBlocks,
        today
      );
 ...
 * }
 */
export async function getTodayCalendarMetrics(
  req: Request,
  res: Response
): Promise<void> {
  try {
...
export async function disconnectCalendar(
  ...
  try {
    ...
    const provider = req.query.provider as CalendarProvider | undefined;
    const calendarService = getCalendarService();
 ...
 * }
 */
export async function getRecentCalendarMetrics(
  req: Request,
  res: Response
): Promise<void> {
  try {
