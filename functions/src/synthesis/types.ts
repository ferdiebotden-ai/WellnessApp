 ...
 */
export const OUTCOME_EXPECTED_DIRECTION: Record<OutcomeMetric, 'positive' | 'negative'> = {
 ...
 */
export const OUTCOME_METRIC_NAMES: Record<OutcomeMetric, string> = {
...
export interface WeeklyMetrics {
  ...
  // Wearable-derived metrics (nullable when data unavailable)
