...
final class HealthKitManager {
    ...
    // MARK: - Supported Health Types

    private static let readableTypes: [HKSampleType] = [
    ...
    private static let observableTypes: [String: HKSampleType] = [
        "HKQuantityTypeIdentifierHeartRateVariabilitySDNN": HKQuantityType.quantityType(forIdentifier: .heartRateVariabilitySDNN)!,
        "HKCategoryTypeIdentifierSleepAnalysis": HKCategoryType.categoryType(forIdentifier: .sleepAnalysis)!,
        "HKQuantityTypeIdentifierRestingHeartRate": HKQuantityType.quantityType(forIdentifier: .restingHeartRate)!,
        "HKQuantityTypeIdentifierStepCount": HKQuantityType.quantityType(forIdentifier: .stepCount)!,
        "HKQuantityTypeIdentifierActiveEnergyBurned": HKQuantityType.quantityType(forIdentifier: .activeEnergyBurned)!
    ]
    ...
    private func handleObserverUpdate(
        ...
        guard error == nil else {
            print("[HealthKit] Observer error for \(typeIdentifier): \(error!.localizedDescription)")
            completion()
            return
        }
